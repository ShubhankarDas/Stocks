...
class StocksController extends Controller
{
    ...
    private function getImageDetailes($name){
        ...
        $imageDetails["tadaysAngle"] = $this->calculateImageDetails($created_url);
        $imageDetails["30TadaysAngle"] = $this->calculateImageDetails($create_year_url);
    ...
    private function calculateImageDetails($res){
        ...
        for($y=0;$y<20;$y++){
            $startPoint = $rgb = imagecolorat($im, 0, $y);
